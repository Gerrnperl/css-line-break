...
export declare const inlineBreakOpportunities: (str: string, options?: IOptions) => string;
declare class Break {
...
export declare const LineBreaker: (str: string, options?: IOptions) => ILineBreakIterator;
export {};
